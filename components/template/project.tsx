  ...
  return (
    ...
    >
      <ItemContent>
        ...
        <ItemDescription className="text-zinc-400">{desc}</ItemDescription>
      </ItemContent>
      <ItemActions>
        <Button
          variant="outline"
          size="sm"
          className="hover:bg-zinc-900 hover:cursor-pointer hover:text-zinc-50 transition-colors duration-300"
        >

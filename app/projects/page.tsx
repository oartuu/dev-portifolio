...
const page = () => {
  return (
    ...
    >
      ...
      <main className="bg-transparent md:w-3/4 flex-1 p-8 flex flex-col items-center space-y-6 ">
        ...
        <div className="w-full grid md:grid-cols-3 gap-4 p-4  overflow-y-hidden ">

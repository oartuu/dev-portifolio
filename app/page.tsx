  ...
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col justify-center items-center space-y-6  ">
        ...
        <h1 className=" text-6xl md:text-9xl  font-bold text-zinc-50 text-shadow-md text-shadow-zinc-600/60">
          oartuu
        </h1>
        <Separator className="bg-zinc-800" />
        <p className="text-zinc-400 px-4 text-center">
          Atualmente trabalhando em{" "}
          <Link
            className="text-zinc-50 hover:underline px-2 "
            href={"/projects/G3"}
          >
            Project.G3
          </Link>{" "}
          uma forma simplificada de gerir apresentações musicais.{" "}
        </p>
      </div>
    </div>
  );
